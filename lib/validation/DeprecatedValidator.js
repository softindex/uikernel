...
class DeprecatedValidator {
    ...
    async isValidRecord(record, additionalValues) {
        const fields = (0, utils_1.keys)(record);
        const additionalFields = additionalValues ? (0, utils_1.keys)(additionalValues) : [];
        ...
        if (notPassedDependentFields.length) {
            throw new ArgumentsError_1.default('Not enough fields for validator: ' + notPassedDependentFields.join(', '));
        }
...
exports.default = DeprecatedValidator;
//# sourceMappingURL=DeprecatedValidator.js.map