...
export type GroupValidationFunction<TRecord extends Record<string, unknown>, TValidatedField extends keyof TRecord & string, TEditableField extends keyof TRecord & string, TAsync extends 'async' | 'sync'> = (record: Pick<TRecord, TValidatedField>, errors: ValidationErrors<TEditableField>) => ValidationResult<void, TAsync>;
