...
export type ValidationFunction<TValue, TAsync extends 'async' | 'sync'> = (value: TValue | undefined) => ValidationResult<string | undefined, TAsync>;
export type GroupValidationFunction<TRecord extends Record<string, unknown>, TEditableField extends keyof TRecord & string, TAsync extends 'async' | 'sync'> = (record: Partial<TRecord>, errors: ValidationErrors<TEditableField>) => ValidationResult<void, TAsync>;
export type ValidatorSettings<TRecord extends Record<string, unknown>, TEditableField extends keyof TRecord & string> = {
