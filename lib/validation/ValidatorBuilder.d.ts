...
declare class ValidatorBuilder<TRecord extends Record<string, unknown>, TEditableField extends keyof TRecord & string, TAsyncGroupValidators extends (keyof TRecord & string)[] = [], TGroupValidators extends (keyof TRecord & string)[] = []> {
    static createEmptyValidator<TRecord extends Record<string, unknown>, TEditable extends keyof TRecord & string>(): IValidator<TRecord, TEditable>;
    private settings;
    ...
    fields<TField extends keyof TRecord & string>(fields: ArrayWithAtLeastOneElement<TField>, groupValidationFunction: GroupValidationFunction<Pick<TRecord, TField>, TField & TEditableField, 'sync'>): ValidatorBuilder<TRecord, TEditableField, TAsyncGroupValidators, [...TGroupValidators, TField]>;
    ...
    asyncFields<TField extends keyof TRecord & string>(fields: ArrayWithAtLeastOneElement<TField>, groupValidationFunction: GroupValidationFunction<Pick<TRecord, TField>, TField & TEditableField, 'async'>): ValidatorBuilder<TRecord, TEditableField, [...TAsyncGroupValidators, TField], TGroupValidators>;
