...
function () {
  ...
  function ListExpressApi() {
    ...
    this.middlewares = {
      read: [(0, _utils.asyncHandler)(function _callee(req, res, next) {
        var model, response;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 1;
                _context.next = 4;
                return _regenerator["default"].awrap(model.read(req.query.v));
      ...
      getLabel: [(0, _utils.asyncHandler)(function _callee2(req, res, next) {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.prev = 2;
                _context2.next = 5;
                return _regenerator["default"].awrap(model.getLabel(id));
