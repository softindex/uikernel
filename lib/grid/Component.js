...
var GridComponent = (0, _createReactClass["default"])(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({
  ...
  getInitialState: function getInitialState() {
    this._throttledUpdateTable = (0, _utils.throttle)(this.updateTable);
    this._validateRow = (0, _utils.throttle)(this._validateRow);
  ...
  renderScrollableGrid: function renderScrollableGrid(gridClassNames) {
    ...
    }, /*#__PURE__*/_react["default"].createElement("colgroup", null, header.colGroup), /*#__PURE__*/_react["default"].createElement("thead", null, header.cols.map(function (row, colKey) {
    ...
    }, /*#__PURE__*/_react["default"].createElement("colgroup", null, header.colGroup), /*#__PURE__*/_react["default"].createElement("tbody", {
