  ...
  (0, _createClass2["default"])(GridComponent, [{
    ...
    value: function clearRecordChanges(recordId) {
      ...
      this.setState({
        ...
        _this5._removeRecordIfNeed(recordId);
      });
    ...
    value: function _setRecordData(recordId, data) {
      ...
      var nextData = new _EqualMap["default"]((0, _toConsumableArray2["default"])(this.state.data).map(function (_ref5) {
      ...
      this.setState({
        ...
        try {
          for (_iterator7.s(); !(_step7 = _iterator7.n()).done;) {
            ...
            _this11._removeRecordIfNeed(recordId);
          }
        } catch (err) {
          _iterator7.e(err);
        } finally {
    ...
    value: function setSelectedRecords(selectedIds, blackListMode) {
      ...
      this.setState({
        ...
        _this12._emitChangeSelectedNum();
      });
    }
    /**
     * Set editor on grid
    ...
    value: function _onChangeEditor(recordId, column, values, editorContext) {
      ...
      var element = this.props.cols[column].editor.call(context, record, this);
    ...
    value: function removeRecordStatus(recordId, status) {
      ...
      this.setState({
        ...
        if (needCheckRemoveRecord) {
          _this15._removeRecordIfNeed(recordId);
        }
      });
    }
    /**
