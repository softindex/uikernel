...
var GridComponent = (0, _createReactClass2.default)((0, _extends3.default)({
  ...
  getInitialState: function getInitialState() {
    ...
    return {
      ...
      selected: [].concat((0, _toConsumableArray3.default)(this.props.selected)),
      showLoader: false
    };
  },
  ...
  componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
    ...
    if (!_utils2.default.isEqual(this.props.selected, nextProps.selected) || this.props.selectBlackListMode !== nextProps.selectBlackListMode) {
    ...
    if (nextProps.selected) {
      this.state.selected = [].concat((0, _toConsumableArray3.default)(nextProps.selected));
    }
