...
var GridComponent = /*#__PURE__*/function (_React$Component) {
  ...
  function GridComponent(props) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "state", {
      ...
      count: 0,
      statuses: new _EqualMap["default"](),
        ...
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 18:
                if (!(_this.getViewCount() && !obj.hasOwnProperty('count'))) {
                  _context.next = 20;
                  break;
                }
              ...
              case 20:
                ...
                page = _this._checkPage(_this.state.page, _this.getViewCount(), obj.count);
              ...
              case 25:
                data = new _EqualMap["default"](obj.records || []);
                extra = new _EqualMap["default"](obj.extraRecords || []);
                ...
                _this.setState({
                  ...
                  statuses: _this._pick(_this.state.statuses, recordIds),
                  showLoader: false
                });
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "_onRecordsCreated", /*#__PURE__*/function () {
      var _ref2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3(recordIds) {
              ...
              case 0:
                ...
                _this.updateTable().then(function () {
                  return Promise.all(recordIds.map( /*#__PURE__*/function () {
                    var _ref3 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(recordId) {
                      var rowId;
                      return _regenerator["default"].wrap(function _callee2$(_context2) {
                        while (1) {
                          switch (_context2.prev = _context2.next) {
                            ...
                            case 2:
                              rowId = _this._getRowID(recordId);
                              _context2.prev = 3;
                              _context2.next = 6;
                              return _this._checkWarnings(rowId);
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "_setData", /*#__PURE__*/function () {
      var _ref4 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee4(changes) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "createEditor", function (event, recordId, colId, ref) {
      ...
      var columnConfig = _this.props.cols[colId];
      ...
      var editor = _this.props.cols[colId].editor;
      ...
      var component = editor.call(editorContext, record, (0, _assertThisInitialized2["default"])(_this));
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "handleChangeViewCount", function (event) {
      var count = _this.props.viewVariants[event.target.value];

      if (_this._isViewCountPropsMode()) {
        _this.props.onChangeViewCount(count);

        return;
      }

      _this.setViewCount(count);
    });
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "_handleColumnClick", function (column) {
      var sortCycle = _this.props.cols[column].sortCycle;
  ...
  (0, _createClass2["default"])(GridComponent, [{
    ...
    value: function UNSAFE_componentWillReceiveProps(nextProps) {
      ...
      if (!(0, _utils.isEqual)(this.props.model, nextProps.model)) {
        reset.add(RESET_MODEL);
      }

      if (!(0, _utils.isEqual)(this.props.viewColumns, nextProps.viewColumns)) {
      ...
      this.setState({}, function () {
        if (reset.has(RESET_SORT) || reset.has(RESET_MODEL) || reset.has(RESET_VIEW_COUNT)) {
          if (reset.has(RESET_MODEL)) {
            ...
            if (oldProps.model) {
              oldProps.model.off('create', _this2._onRecordsCreated);
              oldProps.model.off('update', _this2._setData);
            }

            if (_this2.props.model) {
              _this2.props.model.on('create', _this2._onRecordsCreated);

              _this2.props.model.on('update', _this2._setData);
            }
          ...
          _this2.state.viewColumns = nextProps.viewColumns;
        } else if (reset.has(RESET_SELECTED_COLUMNS)) {
          _this2.state.selected = nextProps.selected;
        } else if (reset.has(RESET_BLACK_LIST_MODE)) {
          _this2.state.selectBlackListMode = !_this2.state.selectBlackListMode;
        }
      });
    }
    /**
    ...
    value: function _getAdditionalIds() {
      ...
      var _iterator2 = _createForOfIteratorHelper(this.state.changes),
          _step2;

      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          var _step2$value = (0, _slicedToArray2["default"])(_step2.value, 1),
              recordId = _step2$value[0];
    ...
    value: function _getRecordsWithStatus() {
      ...
      var _iterator3 = _createForOfIteratorHelper(this.state.statuses),
          _step3;
    ...
    key: "_getRecordErrors",
    value: function _getRecordErrors(recordId) {
    ...
    value: function getErrors() {
      var result = this.state.errors.entries();
    ...
    value: function _getRecordWithChanges(recordId) {
      if (this.state.data.has(recordId)) {
        return _objectSpread(_objectSpread({}, this.state.data.get(recordId)), this.state.changes.get(recordId));
      }

      if (this.state.extra.has(recordId)) {
        return _objectSpread(_objectSpread({}, this.state.extra.get(recordId)), this.state.changes.get(recordId));
      }
    ...
    key: "_setRowChanges",
    value: function _setRowChanges(recordId, data) {
      var changes = (0, _utils.cloneDeep)(this.state.changes);
      changes.set(recordId, (0, _utils.getRecordChanges)(this.props.model, this.state.data.get(recordId) || this.state.extra.get(recordId), changes.get(recordId), data));
    ...
    value: function clearRecordChanges(recordId) {
      ...
      this.setState({
        ...
        _this4._removeRecordIfNeed(recordId);
      });
    ...
    value: function set(recordId, recordChanges) {
      ...
      this.setState({
        ...
        if (_this5.props.autoSubmit) {
          _this5.save();
        } else if (validate) {
          _this5._validateRow(recordId);
        } else if (_this5.props.onChange) {
    ...
    value: function () {
      var _save = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee6() {
        ...
        var errors, changes, data, unhandledErrors, _iterator4, _step4, _loop, _ret, errorHandler;
            ...
            switch (_context7.prev = _context7.next) {
              ...
              case 8:
                ...
                _loop = function _loop() {
                  ...
                  var recordId = _this6._getRowID(record[0]); // Skip records that are user changed while data processing
                  ...
                  if ((0, _utils.isEmpty)(changes.get(recordId))) {
                    ...
                    if (_this6.state.extra.has(recordId)) {
                      _this6._removeRecord(recordId);
                    }
                  }
                };
    ...
    key: "_isFieldAffectsRender",
    value: function _isFieldAffectsRender(field) {
      var i;
      var cols = this.props.cols;
    ...
    key: "_removeRecord",
    value: function _removeRecord(recordId, cb) {
      var changes = (0, _utils.cloneDeep)(this.state.changes);
      var data = (0, _utils.cloneDeep)(this.state.data);
      var warnings = (0, _utils.cloneDeep)(this.state.warnings);
      var errors = (0, _utils.cloneDeep)(this.state.errors);
      var extra = (0, _utils.cloneDeep)(this.state.extra);
      var editor = (0, _utils.cloneDeep)(this.state.editor);
      var touchedChanges = changes.get(recordId);
     ...
     * @private
     */
    value: function _setRecordData(recordId, data) {
      if (!this._isRecordLoaded(recordId)) {
        return;
      }

      var nextData = new Map((0, _toConsumableArray2["default"])(this.state.data).map(function (_ref5) {
        var _ref6 = (0, _slicedToArray2["default"])(_ref5, 2),
            dataRecordId = _ref6[0],
            record = _ref6[1];
    ...
    value: function _dataMapToArray(map) {
      ...
      var _iterator5 = _createForOfIteratorHelper(map),
          _step5;
    ...
    value: function removeRecordStatusAll(status) {
      ...
      var _iterator6 = _createForOfIteratorHelper(statuses),
          _step6;
      ...
      this.setState({
        ...
        var _iterator7 = _createForOfIteratorHelper(checkDeletingRecordIds),
            _step7;
        ...
        try {
          for (_iterator7.s(); !(_step7 = _iterator7.n()).done;) {
            ...
            _this10._removeRecordIfNeed(recordId);
          }
        } catch (err) {
          _iterator7.e(err);
        } finally {
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 15:
                _context8.prev = 15;
                _context8.next = 18;
                return this._checkValidatorErrors(recordId, this.props.model, this._getRecordChanges, this.state.errors);
          ...
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                ...
                return _context11.abrupt("return", new _EqualMap["default"]());

              case 2:
                warnings = this._checkValidatorErrors(recordId, this.props.warningsValidator, this._getRecordWithChanges, this.state.warnings);
                this.setState({
                  warnings: warnings
                });
    ...
    key: "_getWarnings",
    value: function () {
      var _getWarnings2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee11(recordId) {
          ...
          while (1) {
            switch (_context12.prev = _context12.next) {
              case 0:
                ...
                return _context12.abrupt("return", new _EqualMap["default"]());

              case 2:
                return _context12.abrupt("return", this._checkValidatorErrors(recordId, this.props.warningsValidator, this._getRecordWithChanges, this.state.warnings));
      ...
      function _getWarnings(_x9) {
        return _getWarnings2.apply(this, arguments);
      }
    ...
    value: function () {
      var _checkValidatorErrors2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee12(recordId, validator, getData, result) {
        var clonedResult, record, validErrors;
        return _regenerator["default"].wrap(function _callee12$(_context13) {
          while (1) {
            switch (_context13.prev = _context13.next) {
              case 0:
                clonedResult = (0, _utils.cloneDeep)(result);
                record = getData(recordId);
                _context13.next = 4;
                return validator.isValidRecord(record, recordId);

              case 4:
                validErrors = _context13.sent;
                ...
                return _context13.abrupt("return", clonedResult);
      ...
      function _checkValidatorErrors(_x10, _x11, _x12, _x13) {
    ...
    key: "_removeRecordIfNeed",
    value: function _removeRecordIfNeed(recordId) {
     ...
     */
    value: function addRecordStatus(recordId, status) {
      var _this12 = this;

      var recordStatuses = this.state.statuses.get(recordId);
      var statuses = (0, _utils.cloneDeep)(this.state.statuses); // If list does not contain the record, mark its status as empty
    ...
    value: function addRecordStatusGroup(recordIds, status) {
      ...
      var _iterator8 = _createForOfIteratorHelper(recordIds),
          _step8;
    ...
    value: function removeRecordStatus(recordId, status) {
      ...
      var needCheckRemoveRecord = false;
      ...
      this.setState({
        ...
        if (needCheckRemoveRecord) {
          _this14._removeRecordIfNeed(recordId);
        }
      });
    }
    /**
    ...
    value: function getAllWithStatus(status) {
      ...
      var _iterator9 = _createForOfIteratorHelper(this.state.statuses),
          _step9;
    ...
    value: function getAllSelected() {
      ...
      var _iterator10 = _createForOfIteratorHelper(this.state.selected),
          _step10;
     ...
     */
    value: function _getStatuses() {
      var statuses = (0, _utils.cloneDeep)(this.state.statuses);

      if (this.state.selectBlackListMode) {
        var _iterator11 = _createForOfIteratorHelper(this.state.data),
            _step11;

        try {
          for (_iterator11.s(); !(_step11 = _iterator11.n()).done;) {
            var _step11$value = (0, _slicedToArray2["default"])(_step11.value, 1),
      ...
      var _iterator12 = _createForOfIteratorHelper(this.state.selected),
          _step12;
