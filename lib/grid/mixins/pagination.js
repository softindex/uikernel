...
var GridPaginationMixin = {
  ...
  _renderPagination: function _renderPagination() {
    ...
    }, Boolean(this.props.viewVariants) && /*#__PURE__*/_react["default"].createElement(_react.Fragment, null, /*#__PURE__*/_react["default"].createElement("div", {
      key: "0",
    ...
    }, "\xA0"), Boolean(this.state.count) && /*#__PURE__*/_react["default"].createElement("div", null, this.state.page * viewCount + 1, ' - ', Math.min((this.state.page + 1) * viewCount, this.state.count), ' of ', this.state.count), /*#__PURE__*/_react["default"].createElement("button", {
