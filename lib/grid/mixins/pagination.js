...
var GridPaginationMixin = {
  ...
  _renderPagination: function _renderPagination() {
    ...
    }, "\xA0"), Boolean(this.state.count) && _react["default"].createElement("div", null, this.state.page * viewCount + 1, ' - ', Math.min((this.state.page + 1) * viewCount, this.state.count), ' of ', this.state.count), _react["default"].createElement("button", {
