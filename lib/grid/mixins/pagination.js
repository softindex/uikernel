...
var GridPaginationMixin = {
  ...
  _renderPagination: function _renderPagination() {
    var viewCount = this.getViewCount();
    return viewCount ? _react.default.createElement("div", {
      className: "dgrid-footer"
    }, this.props.viewVariants ? [_react.default.createElement("div", {
      key: "0"
    ...
    }, this)))] : null, _react.default.createElement("a", {
      href: "#",
    ...
    }), this.state.count ? _react.default.createElement("div", null, this.state.page * viewCount + 1, ' - ', Math.min((this.state.page + 1) * viewCount, this.state.count), ' of ', this.state.count) : null, _react.default.createElement("a", {
      href: "#",
