...
var GridEditorMixin = {
  ...
  _onBlurEditor: function _onBlurEditor(row) {
    return _regenerator["default"].async(function _onBlurEditor$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _regenerator["default"].awrap(this._checkWarnings(row));
          ...
          case 14:
            _context.prev = 14;
            _context.next = 17;
            return _regenerator["default"].awrap(this._validateRow(row));
