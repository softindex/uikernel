...
var GridDataMixin = {
  ...
  getRecord: function getRecord(recordId) {
    ...
    return _utils.default.cloneDeep(this._getRecord(row));
  },
      ...
      return _regenerator.default.wrap(function _callee4$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 2:
              return _context5.abrupt("return", this._checkValidatorErrors(row, this.props.warningsValidator, this._getRecord, this.state.warnings));
  ...
  _checkValidatorErrors: function () {
    ...
    /*#__PURE__*/
    _regenerator.default.mark(function _callee5(row, validator, getData, result) {
    ...
    return function _checkValidatorErrors(_x4, _x5, _x6, _x7) {
      return _checkValidatorErrors2.apply(this, arguments);
    };
  }(),
  _onRecordCreated: function () {
    var _onRecordCreated2 = (0, _asyncToGenerator2.default)(
    /*#__PURE__*/
    _regenerator.default.mark(function _callee6(recordId) {
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            ...
            case 8:
              ...
              _context7.prev = 11;
              _context7.next = 14;
              return this._checkWarnings(this._getRowID(id));
      ...
      }, _callee6, this, [[6, 25, 29, 37], [11, 16], [30,, 32, 36]]);
    }));

    return function _onRecordCreated(_x8) {
      return _onRecordCreated2.apply(this, arguments);
    };
  }()
};
