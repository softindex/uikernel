...
var GridSortingMixin = {
  ...
  _sortCol: function _sortCol(column) {
    ...
    var newSorts = _utils.default.clone(this.getSortDirection());
    ...
    if (this.props.multipleSorting) {
      ...
      currentSortIndex = _utils.default.findIndex(newSorts, function (sort) {
  ...
  _getDefaultSort: function _getDefaultSort() {
    if (this.props.defaultSort) {
      return _utils.default.cloneDeep(this.props.defaultSort);
    }
  ...
  _getSortParams: function _getSortParams(column) {
    ...
    if (this.props.multipleSorting) {
      sortIndex = _utils.default.findIndex(sorts, function (sort) {
