...
var GridUIMixin = {
  ...
  _updateRow: function _updateRow(row) {
    ...
    return (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2() {
      var viewColumns, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, viewColumn;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 2:
              ...
              viewColumns = (0, _keys2.default)(_this.props.cols).filter(_this._isViewColumn);
              ...
              for (_iterator = (0, _getIterator3.default)(viewColumns); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                ...
                _this._updateField(row, viewColumn);
              }
              _context2.next = 15;
              break;
