...
var GridSelectMixin = {
  ...
  setSelectedRecords: function setSelectedRecords(selectedIds, blackListMode) {
    this.state.selected = _utils.default.clone(selectedIds);
  ...
  selectRecord: function selectRecord(recordId, ignoreBlackList) {
    ...
    if (_utils.default.indexOf(this.state.selected, recordId) < 0) {
  ...
  unselectRecord: function unselectRecord(recordId, ignoreBlackList) {
    ...
    var pos = _utils.default.indexOf(this.state.selected, recordId);
  ...
  isSelected: function isSelected(recordId) {
    var selected = _utils.default.indexOf(this.state.selected, recordId) >= 0;
  ...
  getAllSelected: function getAllSelected() {
    return _utils.default.clone(this.state.selected);
  },
