...
class GridCollectionModel extends AbstractGridModel_1.default {
    ...
    static create({ generateId, data, filtersHandler, requiredFields, validator }) {
        var _a;
        return new GridCollectionModel((_a = (0, cloneDeep_1.default)(data)) !== null && _a !== void 0 ? _a : [], requiredFields !== null && requiredFields !== void 0 ? requiredFields : [], validator !== null && validator !== void 0 ? validator : new Validator_1.default(), filtersHandler, generateId);
    }
