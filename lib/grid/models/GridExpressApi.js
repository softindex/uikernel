    ...
    this.middlewares = {
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  if (req.query.sort) {
                    settings.sort = (0, _utils.parseJson)(req.query.sort, 'Invalid JSON in "sort"');
                  }

                  if (req.query.fields) {
                    settings.fields = (0, _utils.parseJson)(req.query.fields, 'Invalid JSON in "fields"');
                  } else {
                    settings.fields = [];
                  }

                  if (req.query.extra) {
                    settings.extra = (0, _utils.parseJson)(req.query.extra, 'Invalid JSON in "extra"');
                  }

                  if (req.query.filters) {
                    settings.filters = (0, _utils.parseJson)(req.query.filters, 'Invalid JSON in "filters"');
                  }
          ...
          return _regenerator["default"].wrap(function _callee4$(_context4) {
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  cols = req.query.cols ? (0, _utils.parseJson)(req.query.cols, 'Invalid JSON in "cols"') : null;
                  recordId = req.params.recordId ? (0, _utils.parseJson)(req.params.recordId, 'Invalid JSON in "recordId"') : null;
                  model = _this._getModel(req, res);
      ...
      create: [].concat((0, _toConsumableArray2["default"])(multipartFormData ? [upload.any()] : []), [(0, _utils.asyncHandler)( /*#__PURE__*/function () {
        var _ref8 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee6(req, res, next) {
          var model, result, body, _iterator2, _step2, _step2$value, fieldname, buffer, parsedFieldName, data;
