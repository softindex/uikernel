...
var PureGridComponent = /*#__PURE__*/function (_React$Component) {
  ...
  function PureGridComponent(props) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "_renderEditor", function (element) {
      _reactDom["default"].render(_this.props.editor.component, element, function () {
  ...
  (0, _createClass2["default"])(PureGridComponent, [{
    ...
    value: function _shouldRenderBody(prevProps, records) {
      ...
      if (this.props[records] && prevProps[records]) {
        ...
        var _iterator4 = _createForOfIteratorHelper(this.props[records]),
            _step4;
    ...
    value: function _checkPropForRerender(rowsToReRender, prevProps, propType) {
      ...
      if (this.props.records) {
        ...
        var allRecordIds = new Set([].concat((0, _toConsumableArray2["default"])(prevProps[propType].keys().map(JSON.stringify)), (0, _toConsumableArray2["default"])(this.props[propType].keys().map(JSON.stringify))));

        var _iterator5 = _createForOfIteratorHelper(allRecordIds),
            _step5;

        try {
          for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
            var jsonRecordId = _step5.value;
    ...
    value: function _checkRecordsForRender(rowsToReRender, prevProps, recordsType) {
      ...
      if (props[recordsType] && prevProps[recordsType]) {
        ...
        if (props[recordsType] !== prevProps[recordsType]) {
          var _iterator6 = _createForOfIteratorHelper(props[recordsType]),
              _step6;
     ...
     * @private
     */
    value: function _renderRow(recordId, prevEditor) {
    ...
    value: function _extraRecordsOfThePage() {
      ...
      var _iterator7 = _createForOfIteratorHelper(this.props.extraRecords),
          _step7;

      try {
        for (_iterator7.s(); !(_step7 = _iterator7.n()).done;) {
          var _step7$value = (0, _slicedToArray2["default"])(_step7.value, 1),
              recordId = _step7$value[0];
     ...
     * @private
     */
    value: function _hasWarning(row, fields) {
      ...
      if (height) {
        return /*#__PURE__*/_react["default"].createElement("div", {
          ...
          return /*#__PURE__*/_react["default"].createElement("tr", {
            ...
            var header = _this2._getHeaderCellHTML(col.name || col.id);
