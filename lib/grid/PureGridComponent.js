...
var PureGridComponent = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2["default"])(PureGridComponent, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (this._shouldRenderBody(prevProps, 'records') || this._shouldRenderBody(prevProps, 'extraRecords') || !(0, _utils.isEqual)(this.props.viewColumns, prevProps.viewColumns) || this.props.columns !== prevProps.columns) {
        this._renderBody();
