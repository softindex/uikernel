...
var PureGridComponent = /*#__PURE__*/function (_React$Component) {
  ...
  function PureGridComponent(props) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "_escapeRecord", function (columnId, record) {
      ...
      var i;
      var escapedRecord = {};
      var column = _this.props.columns[columnId];
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "_handleBodyClick", function (event) {
      ...
      if (element && !(refParent && refParent.hasAttribute('disabled'))) {
        ...
        var colId = Object.keys(_this.props.columns).filter(function (colId) {
          return _this._isViewColumn(colId);
        })[columnIndex];
  ...
  (0, _createClass2["default"])(PureGridComponent, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (this._shouldRenderBody(prevProps, 'records') || this._shouldRenderBody(prevProps, 'extraRecords') || this.props.viewColumns !== prevProps.viewColumns || this.props.columns !== prevProps.columns) {
        this._renderBody();
    ...
    value: function _checkPropForRerender(rowsToReRender, prevProps, propType) {
      ...
      if (this.props.records) {
        ...
        var allRecordIds = new Set([].concat((0, _toConsumableArray2["default"])((0, _toConsumableArray2["default"])(prevProp.keys()).map(JSON.stringify)), (0, _toConsumableArray2["default"])((0, _toConsumableArray2["default"])(prop.keys()).map(JSON.stringify))));
    ...
    function _renderRow(recordId, prevEditor) {
      ...
      for (var _i = 0, _Object$keys = Object.keys(this.props.columns); _i < _Object$keys.length; _i++) {
    ...
    value: function _renderCell(recordId, colId, row, prevEditor) {
      ...
      var columns = Object.keys(this.props.columns).filter(function (colId) {
        return _this2._isViewColumn(colId);
      });

      if (recordId === this.props.editor.recordId) {
        if (colId === this.props.editor.column) {
          var indexOfColumn = columns.indexOf(this.props.editor.column);
      ...
      if (prevEditor.recordId) {
        if (recordId === prevEditor.recordId && colId === prevEditor.column) {
          var _indexOfColumn = columns.indexOf(prevEditor.column);
      ...
      var cellIndex = columns.indexOf(colId);
    ...
    value: function _getRowHTML(recordId) {
      ...
      for (var _i2 = 0, _Object$keys2 = Object.keys(this.props.columns); _i2 < _Object$keys2.length; _i2++) {
    ...
    value: function _getCellHTML(columnId, record, selected, initialRecord) {
      var render = (0, _utils.last)(this.props.columns[columnId].render);
    ...
    value: function _formHeader() {
      ...
      for (var _i3 = 0, _Object$entries = Object.entries(this.props.columns); _i3 < _Object$entries.length; _i3++) {
    ...
    value: function _renderPagination() {
      ...
      }, " ", this.props.pageSizeLabel), /*#__PURE__*/_react["default"].createElement("div", {
        className: "dgrid-pagination-view-variants"
      }, /*#__PURE__*/_react["default"].createElement("select", {
        className: "dgrid-pagination-view-variants-select",
        value: viewCount,
        onChange: function onChange(e) {
          return onChangeViewCount(Number(e.target.value));
        }
    ...
    value: function _renderTotals(isScrollable) {
      ...
      if (this.props.totals) {
        for (var _i4 = 0, _Object$keys3 = Object.keys(this.props.columns); _i4 < _Object$keys3.length; _i4++) {
          i = _Object$keys3[_i4];
      ...
      if (height) {
        return /*#__PURE__*/_react["default"].createElement("div", {
          ...
          return /*#__PURE__*/_react["default"].createElement("tr", {
            ...
            var header = _this3._getHeaderCellHTML(col.name);
...
PureGridComponent.defaultProps = {
  onChangeViewCount: function onChangeViewCount() {},
  onClickFirstPage: function onClickFirstPage() {},
  onClickPrevPage: function onClickPrevPage() {},
  onClickNextPage: function onClickNextPage() {},
  onClickLastPage: function onClickLastPage() {},
  onRefreshTable: function onRefreshTable() {},
