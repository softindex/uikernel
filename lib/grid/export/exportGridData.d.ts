...
declare function exportGridData<TEditableRecord extends Record<string, unknown>, TRecord extends TEditableRecord, TColumn extends string, TViewColumn extends TColumn, TExportRunner extends (data: FormatDataResult<TViewColumn>) => Promise<{
    data: unknown;
    mime: string;
}>>(gridModel: IGridModel<unknown, TEditableRecord, TRecord, unknown>, columns: Partial<GridColumns<unknown, TEditableRecord, TRecord, TColumn>>, viewColumns: TViewColumn[], exportRunner: TExportRunner, settings: ExportGridDataParams<TRecord>): Promise<ExportGridDataResult<TExportRunner>>;
