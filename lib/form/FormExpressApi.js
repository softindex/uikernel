...
class FormExpressApi {
    ...
    constructor({ multipartFormData = false, maxFileSize = DEFAULT_MAX_FILE_SIZE } = {}) {
        ...
        this.addMidelware('getData', (0, asyncServerRouteHandler_1.default)(async (req, res) => {
            const fields = req.query.fields
                ? (0, parseJson_1.default)(req.query.fields.toString())
                : undefined;
            const result = await this.getModel(req, res).getData(fields);
            this.sendResult(res, result);
        }));
        this.addMidelware('getDataPost', (0, asyncServerRouteHandler_1.default)(async (req, res) => {
        ...
        this.addMidelware('validate', (0, asyncServerRouteHandler_1.default)(async (req, res) => {
            const model = this.getModel(req, res);
    ...
    addMidelware(method, middleware) {
