        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return _regenerator["default"].awrap(model.getRecord(this._adapter.id, fields));
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              model = this._adapter.model;
              _context2.next = 4;
              return _regenerator["default"].awrap(model.update([[this._adapter.id, record]]));
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              model = this._adapter.model;
              _context3.next = 3;
              return _regenerator["default"].awrap(model.isValidRecord(record, this._adapter.id));
