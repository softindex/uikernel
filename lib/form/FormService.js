...
class FormService {
    constructor(fields = []) {
        ...
        this.updateField = async (field, value) => {
            const changes = {};
    ...
    async init({ fields, model, data, changes = {}, warningsValidator = new Validator_1.default(), partialErrorChecking = false, submitAll = false }) {
