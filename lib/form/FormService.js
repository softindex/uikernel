  ...
  (0, _createClass3.default)(FormService, [{
    ...
    value: function clearValidation(fields) {
      ...
      if (Array.isArray(fields)) {
        var _hiddenValidationFiel;

        (_hiddenValidationFiel = this._hiddenValidationFields).push.apply(_hiddenValidationFiel, (0, _toConsumableArray3.default)(fields));
      } else {
    ...
    value: function () {
      var _ref8 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee8() {
        var countOfHiddenValidationFieldsToRemove, errorsWithPartialChecking, warningsWithPartialChecking;
    ...
    value: function _getFields(data, changes, errors, warnings) {
      ...
      var fields = this.fields.reduce(function (newFields, fieldName) {
        ...
        newFields[fieldName].errors = errors && !_this._hiddenValidationFields.includes(fieldName) ? errors.getFieldErrorMessages(fieldName) : null;
        newFields[fieldName].warnings = warnings && !_this._hiddenValidationFields.includes(fieldName) ? warnings.getFieldErrorMessages(fieldName) : null;
        return newFields;
      }, {});
    ...
    value: function _applyPartialErrorChecking(validationErrors) {
      ...
      try {
        for (var _iterator2 = (0, _getIterator3.default)(validationErrors.getErrors().keys()), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          var field = _step2.value;

          var isFieldPristine = !this._changes.hasOwnProperty(field) || _utils2.default.isEqual(this._changes[field], this._data[field]);
