...
class FormService {
    ...
    getAll() {
        ...
        return {
            isLoaded: true,
            data,
            originalData: (_a = this.initializedState.data) !== null && _a !== void 0 ? _a : {},
            changes,
            errors,
            warnings,
    ...
    removeAllListeners() {
        ...
        (_a = this.initializedState.model) === null || _a === void 0 ? void 0 : _a.off('update', this.onModelChange);
    }
    async set(data, validate = false) {
        if (!this.isLoaded() || !this.initializedState.initialized) {
            return;
        }
        this.changes = (0, utils_1.getRecordChanges)(this.initializedState.model.getValidationDependency.bind(this.initializedState.model), this.initializedState.data, this.changes, data);
    ...
    getDisplayedErrors(validationErrors) {
        ...
        const data = (_a = this.initializedState.data) !== null && _a !== void 0 ? _a : {};
    ...
    isDependentField(field) {
        var _a;
        return (this.changes.hasOwnProperty(field) && (0, utils_1.isEqual)(this.changes[field], (_a = this.initializedState.data) === null || _a === void 0 ? void 0 : _a[field]));
    }
