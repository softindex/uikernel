...
var FormMixin = {
   ...
   */
  initForm: (0, _callbackify["default"])(function _callee(settings) {
    var data, err;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 2;
            _context.next = 5;
            return _regenerator["default"].awrap(settings.model.getData(settings.fields));
          ...
          case 13:
            ...
            _context.next = 17;
            return _regenerator["default"].awrap((0, _toPromise["default"])(this.setState.bind(this), true)(this.state));
   ...
   * @param {Function}  [cb]  CallBack function
   */
  submit: (0, _callbackify["default"])(function _callee2() {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            _context2.prev = 9;
            _context2.next = 12;
            return _regenerator["default"].awrap(this.state._formMixin.model.submit(changes));
