...
describe('Can be empty', function () {
  ...
  it('Should return error if date incorrect', function () {
    expect((0, _date["default"])(null, null, 'error msg')('abc')).toEqual('error msg');
    expect((0, _date["default"])(null, null, 'error msg')(true)).toEqual('error msg');
    expect((0, _date["default"])(null, null, 'error msg')(false)).toEqual('error msg');
    expect((0, _date["default"])(null, null, 'error msg')(function () {})).toEqual('error msg');
    expect((0, _date["default"])(null, null, 'error msg')([])).toEqual('error msg');
  });
