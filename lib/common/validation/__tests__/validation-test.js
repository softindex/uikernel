...
var _boolean = require('../rules/boolean');
...
var _enum = require('../rules/enum');

var _enum2 = _interopRequireDefault(_enum);

var _float = require('../rules/float');

var _float2 = _interopRequireDefault(_float);

var _notNull = require('../rules/notNull');

var _notNull2 = _interopRequireDefault(_notNull);

var _number = require('../rules/number');

var _number2 = _interopRequireDefault(_number);

var _regExp = require('../rules/regExp');

var _regExp2 = _interopRequireDefault(_regExp);

var _set = require('../rules/set');
...
describe('ValidationError', function () {
  describe('Check "static createWithError" method', function () {
    it('Should create ValidationErrors instance with one error', function () {
      var validationError = _ValidationErrors2.default.createWithError('test', 'error');
      expect(validationError.toJSON()).toEqual({ test: [{ message: 'error' }] });
    });
  });

  it('add', function () {
    var validationError = _ValidationErrors2.default.createFromJSON({ test: ['error'] });
  ...
  it('merge', function () {
    var validationError = _ValidationErrors2.default.createFromJSON({ test: ['error'] });
    var errorToMerge = _ValidationErrors2.default.createFromJSON({ test2: [{ message: 'error2' }] });
    expect(validationError.merge(errorToMerge).toJSON()).toEqual({ test: [{ message: 'error' }], test2: [{ message: 'error2' }] });
  });
});
...
describe('Validator', function () {
  ...
  it('field', (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
    var result;
  ...
  it('field', (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2() {
    var result;
