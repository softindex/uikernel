  ...
  (0, _createClass3.default)(ValidationErrors, [{
    ...
    value: function merge(validationErrors) {
      ...
      try {
        for (var _iterator2 = (0, _getIterator3.default)(validationErrors.getErrors()), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          ...
          (_errors = errors).push.apply(_errors, (0, _toConsumableArray3.default)(newErrors));
        }
      } catch (err) {
    ...
    value: function createFromJSON(jsonObject) {
      ...
      try {
        ...
        for (var _iterator3 = (0, _getIterator3.default)((0, _entries2.default)(jsonObject)), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
          _loop();
        }
      } catch (err) {
...
ValidationErrors.merge = function () {
  ...
  try {
    for (var _iterator4 = (0, _getIterator3.default)(args), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
