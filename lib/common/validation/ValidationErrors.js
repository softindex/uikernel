...
var ValidationErrors = function () {
  ...
  (0, _createClass3.default)(ValidationErrors, [{
    ...
    value: function merge(error) {
      ...
      this._fields = new _map2.default([].concat((0, _toConsumableArray3.default)(this._fields), (0, _toConsumableArray3.default)(error.getErrors())));
      return this;
    }
    ...
    value: function createFromJSON(jsonObject) {
      ...
      try {
        ...
        for (var _iterator2 = (0, _getIterator3.default)((0, _entries2.default)(jsonObject)), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          _loop();
        }
      } catch (err) {
