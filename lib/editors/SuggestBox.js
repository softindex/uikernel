...
function (_React$Component) {
  ...
  function SuggestBoxEditor(props) {
    ...
    _this._loadData = _utils.default.throttle(_this._loadData);
    _this.state = {
      isOpened: false,
      options: [],
    ...
    _this._onInputFocus = _this._onInputFocus.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
    _this._onInputKeyDown = _this._onInputKeyDown.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
    _this._onInputValueChange = _this._onInputValueChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
    _this._focusOption = _this._focusOption.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
    _this._onDocumentMouseDown = _this._onDocumentMouseDown.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
    _this._onDocumentMouseScroll = _this._onDocumentMouseScroll.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
    _this._toggleList = _this._toggleList.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
    _this._openList = _this._openList.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
    return _this;
  }
  ...
  (0, _createClass2.default)(SuggestBoxEditor, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      return this.state !== nextState || !_utils.default.isEqual(this.props.value, nextProps.value) || this.props.disabled !== nextProps.disabled;
    }
  }, {
    key: "componentWillReceiveProps",
    value: function componentWillReceiveProps(nextProps) {
      if (!_utils.default.isEqual(this.props.value, nextProps.value)) {
    ...
    key: "_updateList",
    value: function () {
      var _updateList2 = (0, _asyncToGenerator2.default)(
      /*#__PURE__*/
      _regenerator.default.mark(function _callee(searchPattern) {
        var options, content;
      ...
      return function _updateList(_x) {
    ...
    key: "_openList",
    value: function () {
      var _openList2 = (0, _asyncToGenerator2.default)(
      /*#__PURE__*/
      _regenerator.default.mark(function _callee2(searchPattern) {
        var _this3 = this;
        ...
        return _regenerator.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 18:
                selectedOptionKey = _utils.default.findIndex(this.state.options, function (option) {
                  return _utils.default.isEqual(option.id, _this3.props.value);
                });
    ...
    key: "_onInputFocus",
    value: function () {
      var _onInputFocus2 = (0, _asyncToGenerator2.default)(
      /*#__PURE__*/
      ...
      return function _onInputFocus(_x3) {
    ...
    key: "_toggleList",
    value: function () {
      var _toggleList2 = (0, _asyncToGenerator2.default)(
      /*#__PURE__*/
    ...
    key: "_focusOption",
    value: function () {
      var _focusOption2 = (0, _asyncToGenerator2.default)(
      /*#__PURE__*/
      _regenerator.default.mark(function _callee5(key, shouldSetLabel) {
      ...
      return function _focusOption(_x4, _x5) {
    ...
    value: function _onDocumentMouseDown(e, isOwner) {
      ...
      if (isOwner) {
        ...
        // q where to test
        if (!_utils.default.parents(target, ".".concat(classes.searchBlock)).length) {
    ...
    value: function () {
      var _onInputValueChange2 = (0, _asyncToGenerator2.default)(
      /*#__PURE__*/
      ...
      return function _onInputValueChange(_x6) {
    ...
    value: function render() {
      ...
      }, _react.default.createElement("input", (0, _extends2.default)({}, _utils.default.omit(this.props, ['model', 'value', 'onChange', 'onLabelChange', 'onFocus', 'select', 'notFoundElement', 'loadingElement', 'defaultLabel', 'onMetadataChange']), {
