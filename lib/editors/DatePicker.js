...
var DatePickerEditor = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2["default"])(DatePickerEditor, [{
    ...
    value: function onChange(date) {
      if (date) {
        date = (0, _dateFns.format)(date, this.props.format);
      }
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement(_reactDatepicker["default"], (0, _extends2["default"])({}, otherProps, {
        ...
        selected: this.props.value && (0, _dateFns.parseISO)(this.props.value),
        onChange: this.onChange.bind(this),
        minDate: this.props.min && (0, _dateFns.parseISO)(this.props.min),
        maxDate: this.props.max && (0, _dateFns.parseISO)(this.props.max),
        startDate: this.props.startDate && (0, _dateFns.parseISO)(this.props.startDate),
        endDate: this.props.endDate && (0, _dateFns.parseISO)(this.props.endDate),
